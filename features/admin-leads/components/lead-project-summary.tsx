    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        <div className="bg-[var(--surface-3)] p-3 rounded-lg">
          <span className="text-[var(--text-muted)] block text-xs mb-1">Project Name</span>
          <span className="text-[var(--text)]">{projectName}</span>
        </div>
        <div className="bg-[var(--surface-3)] p-3 rounded-lg">
          <span className="text-[var(--text-muted)] block text-xs mb-1">Brand Color</span>
      ...
      <div className="bg-[var(--surface-3)] p-4 rounded-lg">
        <span className="text-[var(--text-muted)] block text-xs mb-2">Summary</span>
        <p className="text-[var(--text)] leading-relaxed text-sm">{description}</p>
      </div>

      {answers.length > 0 ? (
        <div className="space-y-3">
          <h4 className="text-xs font-bold uppercase tracking-wider text-[var(--text-muted)]">Answers</h4>
          {answers.map((answer) => (
