    ...
    >
      <header className="app-header">
        <div>
          ...
          <h1 className="app-title">{data?.title || t('more.privacy')}</h1>
        </div>
      </header>

      <div className="app-card rounded-2xl p-6 text-sm leading-relaxed">
        {loading ? (
          ...
          <PageHtmlContent html={data?.description} emptyMessage="Privacy policy content is not available yet." />
        )}
      </div>
    </motion.div>
  );
