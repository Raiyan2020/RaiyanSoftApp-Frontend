...
export const siteConfig = {
  ...
  defaultTitle: 'رايان سوفت | تطوير تطبيقات ومواقع ومتاجر إلكترونية',
  description:
    'رايان سوفت وكالة تقنية تبني تطبيقات الجوال، المواقع الإلكترونية، المتاجر الرقمية، والهويات البصرية بتجربة مستخدم واضحة وأداء جاهز للنمو.',
  locale: 'ar_SA',
  language: 'ar',
  direction: 'rtl',
