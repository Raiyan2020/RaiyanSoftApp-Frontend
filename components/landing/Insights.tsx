      ...
      <div ref={ref} className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          {featuredPost ? (
            ...
            >
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgb(var(--primary-glow-rgb) / 0.35),transparent_36%)]" />
              <div className="relative">
                <span className="rounded-full bg-primary/10 px-3 py-1 text-xs font-bold text-cyan-300">{translateMessage(featuredPost.category || 'Featured Article')}</span>
                ...
                <p className="mt-8 inline-flex items-center gap-2 text-sm font-bold text-cyan-300">
