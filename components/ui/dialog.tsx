...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute end-4 top-4 rounded-full p-1 text-[var(--text-muted)] transition-opacity hover:text-[var(--text)] focus:outline-none">
        <X size={18} />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('text-xl font-bold text-[var(--text)]', className)} {...props} />
));
